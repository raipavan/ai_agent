...
function _loginRole() {
    ...
    return normalizeRole(localStorage.getItem('vernika_role') || 'maruti');
}

function _isDataEdgeCounselorSession() {
    return _loginRole() === 'maruti';
}
...
function updateRoleLabels() {
    ...
    const sess = window.__VERN_SESSION__;
    if (badge) {
        badge.innerHTML = '<span style="font-size:10px;opacity:0.7;">Maruti Suzuki Arena</span>';
